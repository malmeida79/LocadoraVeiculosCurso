...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="gdvVeiculos" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" AutoGenerateEditButton="True" OnPageIndexChanging="gdvVeiculos_PageIndexChanging" OnRowDataBound="gdvVeiculos_RowDataBound" OnRowEditing="gdvVeiculos_RowEditing">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="idMarcaVeiculo" HeaderText="idmarca" SortExpression="codEndereco"/>
            <asp:BoundField DataField="MarcaVeiculo" HeaderText="Marca" SortExpression="codEndereco"/>
            <asp:BoundField DataField="idModeloVeiculo" HeaderText="idModelo" SortExpression="codEndereco"/>
            <asp:BoundField DataField="ModeloVeiculo" HeaderText="Modelo" SortExpression="codEndereco"/>
