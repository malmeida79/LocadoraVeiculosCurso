...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="gdvLocacoes" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" AutoGenerateEditButton="True" OnPageIndexChanging="gdvLocacoes_PageIndexChanging" OnRowDataBound="gdvLocacoes_RowDataBound" OnRowEditing="gdvLocacoes_RowEditing">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="MarcaVeiculo" HeaderText="Marca" SortExpression="MarcaVeiculo"/>
